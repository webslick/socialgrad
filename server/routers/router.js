...
const createRoutes = (app, io) => {
  ...
  router.post('/join_room', RoomsController.joinRoom); // Войти комнату 
  router.delete('/liave_room', RoomsController.liaveRoom); // Покинуть комнату 
  router.delete('/delete_room', RoomsController.deleteRoom); // Удалить комнату 
  ...
  router.get('/get_dialogs_room/:userId', RoomsController.listDiologsRoom); // Получить все диалоги конкретной комнаты
  ...
  router.get('/get_messages_room/:roomId', RoomsController.listMessagesRoom); // Получить все сообщения в комнате 
  router.post('/create_message_room', RoomsController.addMessageRoom); // Создать сообщение в комнате
